            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.firstcontainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  Luna, Iligan City, has never been charged in any kind of offense and has no pending case(s) filed{" "}
              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  <Text style={styles.textregular}>SLAUGHTERHOUSE at Barangay Poctoy, Iligan City.</Text>
